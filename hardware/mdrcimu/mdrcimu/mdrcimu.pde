...
#define MDRC_I2C_OUT 1
#define ROS_ADDR  0x42
...
#if USE_CMPS03==1
  //The error between the compass and the IMU heading
  float dYaw = 0;
  
  //The last heading reading from the
  int cmps_hdg = 0;
#endif
		...
		switch (cycleCount) {
			...
			case(3):
				    ...
				    APM_Compass.Calculate(roll,pitch);  // Calculate heading 
                                  ...
                                  #endif
                                #elif USE_CMPS03==1
                                  yawDelta(CMPS03_ADDR, dYaw, roll, pitch, yaw, CMPS03_MAX_ANGLE);
				#endif
				break;
